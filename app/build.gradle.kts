...
dependencies {
    ...
    implementation("com.github.navikt.aap-libs:ktor-client-auth:2.1.2")
    implementation("com.github.navikt.aap-libs:kafka:2.1.2")
    implementation("com.github.navikt.aap-libs:ktor-utils:2.1.2")
    ...
    testImplementation("com.github.navikt.aap-libs:kafka-test:2.1.2")
